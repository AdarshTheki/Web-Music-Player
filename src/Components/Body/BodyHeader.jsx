    ...
    return (
        <div style={{ position: 'relative' }}>
            <div style={{ width: '100%', overflow: 'hidden' }}>
                <img src={preview_url || picture} alt='bgImage' className='bodyHeaderImage' />
            </div>
                ...
                <div className='bodyHeader__detail'>
                    ...
                    <div className='bodyHeader__other'>
                        ...
                        {album?.album_release_date && (
                            <span>{convertDate(album?.album_release_date || '2023-02-29')}</span>
                        )}
                        {owner && (
                        ...
                        {followers && (
                            <p>{followers?.total?.toLocaleString('en-us', Number) + ' likes'}</p>
                        )}
